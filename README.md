...
|--------|------------|----------------|--------------|
| **FOSYS — AI-Based Workflow Automation System for SCRUM (Flagship)** | 🏆 **Best Paper — IC-AISMART 2025** • AI-assisted orchestration for agile teams with **SCRUM task extraction & structuring, intelligent task assignment, dependency handling, real-time workflow tracking, and automated validation with feedback loops**. Implemented as a full-stack RBAC workspace with **role-based dashboards, PR lifecycle automation, AI meeting transcription → task extraction, Supabase Realtime sync, and webhook integrations**. | React • Supabase • Prisma • FastAPI • PostgreSQL • Webhooks • Realtime | 🔧 *Private / In-Progress* |
