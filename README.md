...
![3 Live Products](https://img.shields.io/badge/%E2%9C%94_3_Live_Products-1D9E75?style=flat-square&labelColor=0F6E56)
![Best Paper IC-AISMART 2025](https://img.shields.io/badge/%F0%9F%8F%86_Best_Paper-IC--AISMART_2025-BA7517?style=flat-square&labelColor=854F0B)
![Bangalore India](https://img.shields.io/badge/Bangalore%2C_India-555?style=flat-square)

<br/>

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/nagesh-kore-7566b6254)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=flat-square&logo=instagram&logoColor=white)](https://www.instagram.com/the.nagesh)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Nagukore)
...
### 🏆 FOSYS — AI Workflow Automation
![Best Paper](https://img.shields.io/badge/Best_Paper-IC--AISMART_2025-BA7517?style=flat-square&labelColor=854F0B)
![Private](https://img.shields.io/badge/Private_Repo-555?style=flat-square)

AI-powered SCRUM orchestrator — meeting transcription → intelligent task extraction with dependency graphs, RBAC dashboards, PR workflow automation, and Supabase Realtime sync.

`React` `FastAPI` `Supabase` `Prisma` `PostgreSQL` `Webhooks`
...
### 🎙️ VoxFlow — Voice-First AI Assistant
...
### 🏥 SS Clinic — Patient-Facing Website
![Live](https://img.shields.io/badge/%E2%97%8F_Live-1D9E75?style=flat-square&labelColor=0F6E56)

Public clinic site with AI chatbot navigation, offline mode, doctor availability lookups, and API-driven appointment workflows.
...
`React` `TypeScript` `Tailwind` `shadcn/ui` `Vite` `Firebase`

</td>
<td width="50%" valign="top">

### 🧠 Enterprise RAG System
[![Repo](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github)](https://github.com/Nagukore/enterprise-rag-system)

Full retrieval-augmented generation pipeline — document ingestion, vector embeddings, semantic search, and AI-powered Q&A over structured and unstructured knowledge bases.

`Python` `FastAPI` `Gemini Embeddings` `NLP`
...
![Qdrant](https://img.shields.io/badge/Qdrant_Vector_DB-DC244C?style=flat-square&logoColor=white)
...
```
▸  API-first — design the contract before the code
